...
constexpr static int32 MinRoundTimeToRespawn = 10;
...
{
	const auto ArrayIndex = TeamID - 1;
	if (ArrayIndex < GameData.TeamColors.Num())
	{
		return GameData.TeamColors[ArrayIndex];
	}
	UE_LOG(LogSTUGameModeBase, Warning,
